        ...
        <Link href={`/providers/${post.provider.id}`} className="flex items-center gap-3 group">
          ...
          <div>
            <div className="flex items-center gap-2">
              <span className="font-semibold text-gray-900 group-hover:text-[#004150] transition-colors">
        ...
        {post.serviceDescription && (
          <div className="bg-gray-50 rounded-lg p-3 mb-3">
            ...
            <Link href={`/providers/${post.provider.id}`}>
              <Button size="sm" className="mt-2 bg-[#004150] hover:bg-[#00303d]">
                Réserver ce service
              </Button>
            </Link>
          </div>
        ...
        {showComments && (
          <div className="border-t pt-3 mt-3 space-y-3">
            ...
            <div className="flex gap-2 items-center">
              <Avatar className="h-8 w-8">
                <AvatarFallback className="text-xs bg-[#004150] text-white">U</AvatarFallback>
              </Avatar>
...
export function FeedPage({
  ...
  return (
    <div className="min-h-screen bg-[#f0f2f5]">
      {/* Header */}
      <div className="bg-gradient-to-r from-[#004150] via-[#005a6e] to-[#004150] py-6 px-4 sticky top-0 z-40 shadow-lg">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <Button
                ...
                className={cn("text-xs", filter === "all" && "bg-white text-[#004150]")}
              >
                Pour vous
              </Button>
              <Button
                ...
                className={cn("text-xs", filter === "following" && "bg-white text-[#004150]")}
              >
                Abonnements
              </Button>
              <Button
                ...
                className={cn("text-xs", filter === "trending" && "bg-white text-[#004150]")}
              >
                Tendances
              </Button>
            </div>
        ...
        <div className="space-y-6">
          {loading ? (
            <div className="flex justify-center py-12">
              <Loader2 className="h-8 w-8 animate-spin text-[#004150]" />
            </div>
          ) : posts.length === 0 ? (
