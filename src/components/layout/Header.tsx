    ...
    <nav className="fixed top-0 w-full z-50 bg-white/70 backdrop-blur-xl shadow-sm">
      <div className="flex justify-between items-center px-6 py-4 max-w-screen-2xl mx-auto">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link
            href="/publications"
            className="text-slate-600 hover:text-primary transition-colors font-semibold flex items-center gap-1"
          >
        ...
        <Sheet open={isOpen} onOpenChange={setIsOpen}>
          ...
          <SheetContent side="right" className="w-[300px]">
            ...
            <div className="flex flex-col gap-4 mt-6">
              <Link
                href="/services"
                className="text-[#181c1d] hover:text-primary transition-colors font-semibold py-2"
              ...
              <Link
                href="/publications"
                className="text-[#181c1d] hover:text-primary transition-colors font-semibold py-2 flex items-center gap-2"
                onClick={() => setIsOpen(false)}
              >
                <FileText className="h-4 w-4" />
                Publications
