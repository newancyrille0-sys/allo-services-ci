...
export function TrustSection() {
  return (
    <section className="max-w-screen-2xl mx-auto px-6 mt-32">
      <div className="bg-[#005a6e] rounded-[3rem] p-10 md:p-20 overflow-hidden relative">
        {/* Background Icon */}
                ...
                return (
                  <div key={index} className="flex gap-4">
                    <div className="bg-white/10 p-3 rounded-2xl shrink-0">
                      <Icon className="w-6 h-6 text-[#8ed0e7]" />
                    </div>
                    <div>
          ...
          <div className="relative">
            <div className="glass-card p-8 rounded-[2.5rem] relative z-20">
              ...
              <div className="flex items-center gap-4 mb-8">
                <div className="w-12 h-12 bg-[#004150] rounded-full flex items-center justify-center text-white font-bold">
                  AS
                </div>
                <div>
                  <div className="text-[#004150] font-bold">Allo Services Support</div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-[#004150] text-white p-4 rounded-2xl rounded-tr-none ml-12 text-sm">
            ...
            <div className="absolute -top-20 -right-20 w-60 h-60 bg-[#8ed0e7] rounded-full blur-[100px] opacity-10" />
          </div>
        </div>
      </div>
    </section>
